...
urlpatterns = [
    ...
    path('remove_entire_from_cart/<slug:category_slug>/<slug:slug>/', remove_from_cart, name="remove_entire_from_cart" ),
    path('remove_single_from_cart/<slug:category_slug>/<slug:slug>/', remove_single_item_from_cart, name="remove_single_from_cart" ),
]
